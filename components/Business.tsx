...
const WhyCard = ({
  ...
  <ScrollReveal delay={index * 100}>
    <div className="flex flex-col p-6 rounded-2xl border border-gray-200 bg-white shadow-sm feature-card transition-all cursor-default hover:border-secondary/30 h-full">
