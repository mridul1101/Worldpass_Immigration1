...
const ServiceCard = ({
  ...
  <ScrollReveal delay={index * 100}>
    <div
      className="flex flex-col bg-white rounded-2xl border border-gray-200 p-7 shadow-sm service-card transition-all cursor-default hover:border-secondary/30 h-full"
    >
      ...
      <Link
        href="/contact"
        className="mt-auto pt-6 block text-center py-2.5 px-5 bg-secondary text-white font-poppins font-semibold text-[13px] rounded-full hover:bg-blue-700 transition-all"
      >
        Enquire Now →
      </Link>
    </div>
