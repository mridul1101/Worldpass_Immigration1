...
import styles from '../style'
import { footerLinks, socialMedia } from '../constants'
import worldpassLogo from '../assets/worldpass_logo.jpeg'
...
const Footer = () => {
  return (
    <section className={`${styles.flexCenter} ${styles.paddingY} flex-col`}>
      <div className={`${styles.flexStart} md:flex-row flex-col mb-8 w-full`}>
        ...
        <div className='flex-1 flex flex-col justify-start mr-10'>
          ...
          <p className={`${styles.paragraph} mt-4 max-w-[320px]`}>
            We provide trusted immigration guidance for students, workers, and families.
            Our team helps you plan, apply, and move forward with confidence.
          </p>
          ...
          <div className='mt-6 text-dimWhite text-[15px] leading-[24px]'>
            ...
            <p className='mb-2'>
              <span className='text-white font-semibold'></span>  
              {' '}Call / WhatsApp: <a href='tel:+918278776068' className='hover:text-secondary cursor-pointer'>+91 82787 76068</a>
            </p>
            <p>
              <span className='text-white font-semibold'></span>  
              {' '}📧 Email: <a href='mailto:worldpassimmigrationservices@gmail.com' className='hover:text-secondary cursor-pointer'>worldpassimmigrationservices@gmail.com</a>
            </p>
          </div>
        </div>
      ...
      <div className='w-full flex justify-between items-center md:flex-row flex-col pt-6 border-t-[1px] border-t-[#3F3E45]'>
        <p className='font-poppins font-normal text-center text-[18px] leading-[27px] text-white'>
          © {new Date().getFullYear()} World Pass Immigration. All rights reserved.
        </p>  
        <div className='flex flex-row md:mt-0 mt-6'>
          {socialMedia.map((social, index) => (
            <a
